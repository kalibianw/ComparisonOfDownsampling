...
class TrainModuleForLargeModel:
    def __init__(self, input_shape, output_shape, ckpt_path, model_path, log_dir_path, batch_size, epochs):
        self.INPUT_SHAPE = input_shape
        self.OUTPUT_SHAPE = output_shape
        self.CKPT_PATH = ckpt_path
    ...
    def create_basic_cnn_model(self):
        ...
        max_pool_4 = layers.MaxPooling2D(pool_size=(2, 2), padding="same")(batch_normalization_2)

        conv2d_5 = layers.Conv2D(filters=256, kernel_size=(3, 3), padding="same", activation=activations.selu,
                                 kernel_initializer="he_uniform", kernel_regularizer=regularizers.L2())(max_pool_4)
        conv2d_5_ = layers.Conv2D(filters=256, kernel_size=(3, 3), padding="same", activation=activations.selu,
                                  kernel_initializer="he_uniform", kernel_regularizer=regularizers.L2())(conv2d_5)
        max_pool_5 = layers.MaxPooling2D(pool_size=(2, 2), padding="same")(conv2d_5_)

        conv2d_6 = layers.Conv2D(filters=512, kernel_size=(3, 3), padding="same", activation=activations.selu,
                                 kernel_initializer="he_uniform", kernel_regularizer=regularizers.L2())(max_pool_5)
        conv2d_6_ = layers.Conv2D(filters=512, kernel_size=(3, 3), padding="same", activation=activations.selu,
                                  kernel_initializer="he_uniform", kernel_regularizer=regularizers.L2())(conv2d_6)
        batch_normalization_3 = layers.BatchNormalization()(conv2d_6_)
        max_pool_6 = layers.MaxPooling2D(pool_size=(2, 2), padding="same")(batch_normalization_3)

        flatten = layers.Flatten()(max_pool_6)
    ...
    def create_avg_pooling_cnn_model(self):
        ...
        conv2d_4_ = layers.Conv2D(filters=128, kernel_size=(3, 3), padding="same", activation=activations.selu,
                                  kernel_initializer="he_uniform", kernel_regularizer=regularizers.L2())(conv2d_4)
        batch_normalization_2 = layers.BatchNormalization()(conv2d_4_)
        avg_pool_4 = layers.AveragePooling2D(pool_size=(2, 2), padding="same")(batch_normalization_2)

        conv2d_5 = layers.Conv2D(filters=256, kernel_size=(3, 3), padding="same", activation=activations.selu,
                                 kernel_initializer="he_uniform", kernel_regularizer=regularizers.L2())(avg_pool_4)
        conv2d_5_ = layers.Conv2D(filters=256, kernel_size=(3, 3), padding="same", activation=activations.selu,
                                  kernel_initializer="he_uniform", kernel_regularizer=regularizers.L2())(conv2d_5)
        avg_pool_5 = layers.AveragePooling2D(pool_size=(2, 2), padding="same")(conv2d_5_)

        conv2d_6 = layers.Conv2D(filters=512, kernel_size=(3, 3), padding="same", activation=activations.selu,
                                 kernel_initializer="he_uniform", kernel_regularizer=regularizers.L2())(avg_pool_5)
        conv2d_6_ = layers.Conv2D(filters=512, kernel_size=(3, 3), padding="same", activation=activations.selu,
                                  kernel_initializer="he_uniform", kernel_regularizer=regularizers.L2())(conv2d_6)
        batch_normalization_3 = layers.BatchNormalization()(conv2d_6_)
        avg_pool_6 = layers.AveragePooling2D(pool_size=(2, 2), padding="same")(batch_normalization_3)

        flatten = layers.Flatten()(avg_pool_6)
    ...
    def create_strided_cnn_model(self):
        ...
        conv2d_4 = layers.Conv2D(filters=128, kernel_size=(3, 3), strides=1, padding="same",
                                 activation=activations.selu, kernel_initializer="he_uniform",
                                 kernel_regularizer=regularizers.L2())(conv2d_1b1)
        conv2d_4_2 = layers.Conv2D(filters=128, kernel_size=(3, 3), strides=2, padding="same",
                                   activation=activations.selu, kernel_initializer="he_uniform",
                                   kernel_regularizer=regularizers.L2())(conv2d_4)

        batch_normalization_2 = layers.BatchNormalization()(conv2d_4_2)

        conv2d_5 = layers.Conv2D(filters=256, kernel_size=(3, 3), strides=1, padding="same",
                                 activation=activations.selu, kernel_initializer="he_uniform",
                                 kernel_regularizer=regularizers.L2())(batch_normalization_2)
        conv2d_5_2 = layers.Conv2D(filters=256, kernel_size=(3, 3), strides=2, padding="same",
                                   activation=activations.selu, kernel_initializer="he_uniform",
                                   kernel_regularizer=regularizers.L2())(conv2d_5)

        conv2d_6 = layers.Conv2D(filters=512, kernel_size=(3, 3), strides=1, padding="same",
                                 activation=activations.selu, kernel_initializer="he_uniform",
                                 kernel_regularizer=regularizers.L2())(conv2d_5_2)
        conv2d_6_2 = layers.Conv2D(filters=512, kernel_size=(3, 3), strides=2, padding="same",
                                   activation=activations.selu, kernel_initializer="he_uniform",
                                   kernel_regularizer=regularizers.L2())(conv2d_6)

        batch_normalization_3 = layers.BatchNormalization()(conv2d_6_2)

        flatten = layers.Flatten()(batch_normalization_3)
    ...
    def create_strided_cnn_model_2(self):
        ...
        conv2d_4 = layers.Conv2D(filters=128, kernel_size=(3, 3), strides=1, padding="same",
                                 activation=activations.selu, kernel_initializer="he_uniform",
                                 kernel_regularizer=regularizers.L2())(conv2d_1b1)
        conv2d_4_1 = layers.Conv2D(filters=128, kernel_size=(3, 3), strides=1, padding="same",
                                   activation=activations.selu, kernel_initializer="he_uniform",
                                   kernel_regularizer=regularizers.L2())(conv2d_4)
        conv2d_4_2 = layers.Conv2D(filters=128, kernel_size=(3, 3), strides=2, padding="same",
                                   activation=activations.selu, kernel_initializer="he_uniform",
                                   kernel_regularizer=regularizers.L2())(conv2d_4_1)
        ...
        conv2d_5 = layers.Conv2D(filters=256, kernel_size=(3, 3), strides=1, padding="same",
                                 activation=activations.selu, kernel_initializer="he_uniform",
                                 kernel_regularizer=regularizers.L2())(batch_normalization_2)
        conv2d_5_1 = layers.Conv2D(filters=256, kernel_size=(3, 3), strides=1, padding="same",
                                   activation=activations.selu, kernel_initializer="he_uniform",
                                   kernel_regularizer=regularizers.L2())(conv2d_5)
        conv2d_5_2 = layers.Conv2D(filters=256, kernel_size=(3, 3), strides=2, padding="same",
                                   activation=activations.selu, kernel_initializer="he_uniform",
                                   kernel_regularizer=regularizers.L2())(conv2d_5_1)

        conv2d_6 = layers.Conv2D(filters=512, kernel_size=(3, 3), strides=1, padding="same",
                                 activation=activations.selu, kernel_initializer="he_uniform",
                                 kernel_regularizer=regularizers.L2())(conv2d_5_2)
        conv2d_6_1 = layers.Conv2D(filters=512, kernel_size=(3, 3), strides=1, padding="same",
                                   activation=activations.selu, kernel_initializer="he_uniform",
                                   kernel_regularizer=regularizers.L2())(conv2d_6)
        conv2d_6_2 = layers.Conv2D(filters=512, kernel_size=(3, 3), strides=2, padding="same",
                                   activation=activations.selu, kernel_initializer="he_uniform",
                                   kernel_regularizer=regularizers.L2())(conv2d_6_1)
