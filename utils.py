...
class TrainModule:
    ...
    def create_obo_cnn_model_2(self):
        input_layer = layers.Input(shape=self.INPUT_SHAPE)
        ...
        conv2d_obo_2 = layers.Conv2D(filters=32, kernel_size=(1, 1), padding="same", activation=activations.relu,
                                     kernel_initializer="he_uniform", kernel_regularizer=regularizers.L2(),
                                     name="obo_2")(batch_normalization_2)

        flatten = layers.Flatten()(conv2d_obo_2)
