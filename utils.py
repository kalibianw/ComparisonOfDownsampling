...
class TrainModule:
    ...
    def create_basic_cnn_model(self):
        ...
        conv2d_1_ = layers.Conv2D(filters=64, kernel_size=(3, 3), padding="same", activation=activations.relu,
        ...
        conv2d_2_ = layers.Conv2D(filters=128, kernel_size=(3, 3), padding="same", activation=activations.relu,
        ...
        conv2d_3_ = layers.Conv2D(filters=256, kernel_size=(3, 3), padding="same", activation=activations.relu,
        ...
        dense_1 = layers.Dense(units=512, activation=activations.relu, kernel_initializer="he_uniform",
                               kernel_regularizer=regularizers.L2())(flatten)
        dropout_1 = layers.Dropout(rate=0.5)(dense_1)
        dense_2 = layers.Dense(units=128, activation=activations.relu, kernel_initializer="he_uniform",
    ...
    def create_strided_cnn_model(self):
        ...
        conv2d_1 = layers.Conv2D(filters=64, kernel_size=(3, 3), strides=1, padding="same",
                                 activation=activations.relu, kernel_initializer="he_uniform",
    ...
    def create_concat_cnn_model(self):
        ...
        conv2d_1_4 = layers.Conv2D(filters=256, kernel_size=(3, 3), padding="same", activation=activations.relu,
                                   kernel_initializer="he_uniform", name="conv2d_1_4",
        ...
        dense_1 = layers.Dense(units=1024, activation=activations.relu, kernel_initializer="he_uniform",
                               name="dense_1", kernel_regularizer=regularizers.L2())(flatten)
        dropout_1 = layers.Dropout(rate=0.5)(dense_1)
        dense_2 = layers.Dense(units=512, activation=activations.relu, kernel_initializer="he_uniform",
                               name="dense_2", kernel_regularizer=regularizers.L2())(dropout_1)
        dropout_2 = layers.Dropout(rate=0.5)(dense_2)
        dense_3 = layers.Dense(units=128, activation=activations.relu, kernel_initializer="he_uniform",
